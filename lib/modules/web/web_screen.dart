...
import 'package:facebook_ui_task/models/user_model.dart';
...
class HomeWebScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildUserItem(User model, context, index) => Padding(
            ...
            child: Column(
              children: [
                ...
                ListView.separated(
                  ...
                  physics: NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) =>
                      buildUserItem(onlineUsers[index], context, index),
                  separatorBuilder: (context, index) => SizedBox(
